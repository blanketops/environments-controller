...
// gitrepository.go constructs this controller's GitRepository domain cache: a thin
// wrapper around blanketops-environments-core's cache/gitrepository package.
//
