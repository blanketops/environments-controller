...
// GitHubPayload reconciles a GitHubEvent object
...
func (r *GitHubPayload) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
// -----------------------------------------------------------------
func (r *GitHubPayload) SetupWithManager(mgr ctrl.Manager) error {
	// ---------------------------------------------------------------------
	// Controller registration
	// ---------------------------------------------------------------------
	return ctrl.NewControllerManagedBy(mgr).
		For(&eventsv1alpha1.GitHubPayload{}).
		Named("events-gitpayload").
